...
//        }
    ...
    public static void main(String[] args) {
        ...
        Benchmark<Integer[]> bt = new Benchmark_Timer<>("Benchmark", null, (b) -> is.sort(b, 0, b.length), null);
        for (int i = 100; i < 8000; i *= 2) {
            int c = i;
            Supplier<Integer[]> supplier = () -> {
            ...
            double t = bt.runFromSupplier(supplier, 10);
            System.out.println(" N is :" + i + " for random and time taken is :" + t);
        }
        ...
        for (int i = 100; i < 8000; i *= 2) {
            ...
            double t = bt.runFromSupplier(supplier, 10);
            System.out.println("N is " + i + "Ordered and time taken is " + t);
        }
        ...
        for (int i = 100; i < 8000; i *= 2) {
            ...
            Supplier<Integer[]> supplier = () -> {
                ...
                for (int q = 0; q < half; q++) {
                    int point = rm.nextInt(c);
                    arr[point] = rm.nextInt(c * 100);
                }
                return arr;
            };
            double t = bt.runFromSupplier(supplier, 10);
            System.out.println("N is " + i + " Partially Ordered Situation and time taken is " + t);
        }
        ...
        for (int i = 100 ; i < 8000; i*=2){
            ...
            double t = bt.runFromSupplier(supplier, 10);
            System.out.println("N is " + i + " Reverse Ordered and time taken is " + t);
        }
    }
}
